...
class CouplingTransform(Transform):
    ...
    def forward(self, inputs, context=None):
        ...
        identity_split = torch.cat((identity_split, torch.zeros_like(identity_split)), dim=1)
        transform_params = self.transform_net(context, identity_split) # SWAPPED
        ...
        outputs[:, self.identity_features, ...] = identity_split[:, :33] # pathetic
